...
//        apiControllerCodegen.setGeneratorPropertyDefault(CodegenConstants.SUPPORTING_FILES, "swaggerDocumentationConfig.mustache");
    ...
    private List<File> generateErdService(String outputDir) {
        ...
        code.setDbUsername("root");
        code.setDbPassword("root");
        code.setDbUrl("jdbc:mysql://localhost:3306/martin?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8");
        code.setModuleName("");
        code.setParent("com.java2e.martin.biz.system");
//        code.setTableName("t_module,t_entity,t_field,t_datatype");
        code.setTableName("sys_announcement");
        code.setTablePrefix("");
        return mybatisPlusCodegen.generateService(code, outputDir);
    }
